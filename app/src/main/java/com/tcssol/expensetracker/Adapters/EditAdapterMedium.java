...
public class EditAdapterMedium extends RecyclerView.Adapter<EditAdapterMedium.ViewHolder> {
    public List<String> list;
    public final Context context;
    private final OnEditMediumItemClickListner EditMediumItemClickListner;
    public EditAdapterMedium(Context context, List<String> list, OnEditMediumItemClickListner editItemClickListner){
        this.list=list;
        this.context=context;
        this.EditMediumItemClickListner=editItemClickListner;
        Log.d("EditAdapterSubCategory","Created EditAdapterAdapter");
    }
    @NonNull
    @Override
    public EditAdapterMedium.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view= LayoutInflater.from(parent.getContext())
                .inflate(R.layout.edit_adapter_item,parent,false);
        Log.d("EditAdapter","CreatingView");
        return new EditAdapterMedium.ViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull EditAdapterMedium.ViewHolder holder, int position) {
        ...
        }else if(list.get(position).equals("Cash")){
            holder.delete.setVisibility(View.GONE);
    ...
    public class ViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener, View.OnLongClickListener {
        ...
        OnEditMediumItemClickListner onEditMediumItemClickListner;
        ...
        public void onClick(View v) {
            ...
            if(id==R.id.imageButtonCross){
                ...
                onEditMediumItemClickListner.addMediumItem();
            }
        }

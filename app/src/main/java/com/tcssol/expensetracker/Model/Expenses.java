...
public class Expenses {
    ...
    @Ignore
    public Expenses(LocalDate dateCreated, String category, String subCategory, String mode, double amount, boolean type, String note) {
        this.dateCreated = dateCreated;
        this.category = category;
        this.subCategory = subCategory;
        this.mode = mode;
    ...
    public static String toCsvFormat(Expenses expenses) {
        ...
        String noteStr = expenses.getNote() != null ? expenses.getNote().replace(",", ";") : "";
        return String.format("%d,%s,%s,%s,%s,%s,%s,%s\n",
                expenses.getId(), expenses.getCategory(), expenses.getSubCategory(),
                expenses.getMode(), Converters.toString(expenses.getDateCreated()),
                typeString, expenses.getAmount(), noteStr);
    }

    public static String toTxtFormat(Expenses expenses) {
        String typeString = String.valueOf(expenses.isType());
        String noteStr = expenses.getNote() != null ? expenses.getNote() : "";
        return String.format("%d\t%s\t%s\t%s\t%s\t%s\t%s\t%s\n",
                expenses.getId(), expenses.getCategory(), expenses.getSubCategory(),
                expenses.getMode(), Converters.toString(expenses.getDateCreated()),
                typeString, expenses.getAmount(), noteStr);
